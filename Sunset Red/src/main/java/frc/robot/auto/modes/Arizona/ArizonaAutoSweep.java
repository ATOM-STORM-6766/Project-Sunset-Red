...
public class ArizonaAutoSweep {
    /**
     * Arizona Sweep has two modes, NEAR and FAR
     * NEAR mode takes the START_ARIZONA_NEAR path
     * FAR mode takes the START_ARIZONA_FAR path
     * 
     * Both modes start with a buildPathThenChaseNoteCommand to intake 51/55
     * And then they eject note 51/55 using Drop
     * Finally the just directly move to 55/51 (Opposite of the field), in a
    ...
    public static Command buildArizonaSweepCommand(DrivetrainSubsystem drivetrainSubsystem, Arm arm, Shooter shooter,
            Transfer transfer, Intake intake, ArizonaSweepMode mode) {
