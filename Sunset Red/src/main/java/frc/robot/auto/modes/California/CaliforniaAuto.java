  ...
  public static Command buildCaliforniaAuto(
    ...
    return new SequentialCommandGroup(
        ...
        AutoBuilder.pathfindThenFollowPath(
                params.firstNoteShootConfig.approachShootPosePath, PathfindConstants.constraints)
            .deadlineWith(
                new SetArmAngleCommand(arm, params.firstNoteShootConfig.shootParams.angle_deg),
                new SetShooterTargetCommand(
                    shooter, params.firstNoteShootConfig.shootParams.speed_rps)),
        ...
        AutoBuilder.pathfindThenFollowPath(
                params.secondNoteShootConfig.approachShootPosePath, PathfindConstants.constraints)
            .deadlineWith(
                new SetArmAngleCommand(arm, params.secondNoteShootConfig.shootParams.angle_deg),
                new SetShooterTargetCommand(
                    shooter, params.secondNoteShootConfig.shootParams.speed_rps)),
        ...
        AutoBuilder.pathfindThenFollowPath(
                params.thirdNoteShootConfig.approachShootPosePath, PathfindConstants.constraints)
            .deadlineWith(
                new SetArmAngleCommand(arm, params.thirdNoteShootConfig.shootParams.angle_deg),
                new SetShooterTargetCommand(
                    shooter, params.thirdNoteShootConfig.shootParams.speed_rps)),
