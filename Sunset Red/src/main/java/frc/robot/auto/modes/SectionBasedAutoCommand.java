                ...
                new SequentialCommandGroup(
                        ...
                        new ConditionalCommand(
                                new SequentialCommandGroup(
                                        ...
                                        new ChaseNoteCommand(sDrivetrainSubsystem, GamePieceProcessor.getInstance(),
                                                sIntake, sTransfer),
                        ...
                        new ConditionalCommand(
                                ...
                                .alongWith(new SetShooterTargetCommand(sShooter,
                                        ShootingParameters.BELOW_SPEAKER.speed_rps))
                                .alongWith(new SetArmAngleCommand(sArm, ShootingParameters.BELOW_SPEAKER.angle_deg)),
