...
public class DallasAuto extends SequentialCommandGroup {
  ...
  private static final Pose2d kShootPoseUnderStage =
      new Pose2d(4.5, 4.34, Rotation2d.fromDegrees(-14));
  ...
  public DallasAuto(
    ...
    switch (strategy) {
      ...
      case START_53_THEN_TRAP:
        addCommands(
            buildStart53ThenTrapSequence(
                drivetrainSubsystem, arm, shooter, transfer, intake, trapFan));
        break;
    }
  }

  private Command buildStart53Sequence(
      DrivetrainSubsystem drivetrainSubsystem,
      Arm arm,
      Shooter shooter,
      Transfer transfer,
  ...
  private Command buildStart52Sequence(
      DrivetrainSubsystem drivetrainSubsystem,
      Arm arm,
      Shooter shooter,
      Transfer transfer,
  ...
  private Command buildStart53ThenTrapSequence(
      DrivetrainSubsystem drivetrainSubsystem,
      Arm arm,
      Shooter shooter,
      Transfer transfer,
