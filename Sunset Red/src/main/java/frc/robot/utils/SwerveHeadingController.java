...
public class SwerveHeadingController {
    ...
    public SwerveHeadingController() {
        swerveRotateConstraints = new TrapezoidProfile.Constraints(Units.degreesToRadians(180),
        ...
        swerveHeadingPID.enableContinuousInput(Units.degreesToRadians(-180), Units.degreesToRadians(180));
    }
