...
public class Shooter extends SubsystemBase {
  ...
  /**
   * @brief a way to tell the shooter to stop (apply neutral out) a wrapper for
   *     `setTargetVelocity(0)`
   */
  public void stop() {
    setTargetVelocity(0);
  ...
  public boolean isReadyToShoot() {
    return mSpinStablized.update(
        Timer.getFPGATimestamp(),
        mPeriodicIO.shooterVelocity > SHOOT_THRESHOLD_RPS
            && mPeriodicIO.followerVelocity > SHOOT_THRESHOLD_RPS
