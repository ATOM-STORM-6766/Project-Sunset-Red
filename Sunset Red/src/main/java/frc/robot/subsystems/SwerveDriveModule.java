...
public class SwerveDriveModule{
    ...
    public ControlRequest azimuthSelectedControl = azimuthPosition; // default to position control, can be changed to
    ...
    public SwerveDriveModule(SwerveModuleConfig config) {
        ...
        mAzimuthConfigs.ClosedLoopGeneral.ContinuousWrap = true; // This is important for azimuth control
        mAzimuthConfigs.Feedback.SensorToMechanismRatio = AZIMUTH_GEAR_RATIO;

        Util.checkReturn("swerve azimuth",
        ...
        Util.checkReturn("swerve azimuth position", mAzimuthMotor.getPosition()
                .setUpdateFrequency(DebugConstants.kOdomUpdateFreq, DebugConstants.kLongCANTimeoutSec));
        Util.checkReturn("swerve azimuth velocity", mAzimuthMotor.getVelocity()
                .setUpdateFrequency(DebugConstants.kOdomUpdateFreq, DebugConstants.kLongCANTimeoutSec));
        Util.checkReturn("swerve azimuth canbus",
        ...
        Util.checkReturn("swerve drive",
                mDriveMotor.getConfigurator().apply(mDriveConfig, DebugConstants.kLongCANTimeoutSec));
        mDriveMotor.setControl(new NeutralOut());
        Util.checkReturn("swerve drive position", mDriveMotor.getPosition()
                .setUpdateFrequency(DebugConstants.kOdomUpdateFreq, DebugConstants.kLongCANTimeoutSec));
        Util.checkReturn("swerve drive velocity", mDriveMotor.getVelocity()
                .setUpdateFrequency(DebugConstants.kOdomUpdateFreq, DebugConstants.kLongCANTimeoutSec));
        Util.checkReturn("swerve drive canbus", mDriveMotor.optimizeBusUtilization(DebugConstants.kLongCANTimeoutSec));
    ...
    /**
     * Sets the desired state of the swerve drive module.
     * The desired state includes the desired angle and speed of the module.
     * The method optimizes the desired state based on the current angle of the
     * module.
     * It then sets the azimuth angle and drive velocity accordingly.
     *
    ...
    public void setDriveVelocity(double velocityMetersPerSecond) {
        ...
        double targetRPS = velocityMetersPerSecond / wheelCircumferenceMeters; // no need to adjust for gear ratio
    ...
    /**
     * Returns the state of the swerve drive module.
     * The state includes the velocity in meters per second and the azimuth rotation
     * in radians.
     *
    ...
    public SwerveModuleState getState() {
        ...
        double velocityMPS = mDriveMotor.getVelocity().getValueAsDouble() * DriveConstants.kChassisWheelDiameterMeters
                * Math.PI;
    ...
    /**
     * Represents the position of a swerve drive module.
     * The position includes the distance traveled in meters and the azimuth
     * rotation in radians.
     */
    public SwerveModulePosition getPosition() {
        ...
        double distanceMeters = mDriveMotor.getPosition().getValueAsDouble()
