...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        new Trigger(() -> driverController.snapToAmpAngle()
                && driverController.getRawRotationRate() == 0.0).onTrue(new SnapToAngleCommand(
    ...
    public void pushChooser() {
        ...
        mChooser.setDefaultOption("california", new CaliforniaAutoCommand(sDrivetrainSubsystem,
                mArm, mShooter, mTransfer, mIntake));
