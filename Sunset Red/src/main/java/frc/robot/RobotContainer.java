...
public class RobotContainer {
    ...
    public Optional<Rotation2d> getDriveTargetHeading() {
        Optional<Rotation2d> rightStickHeading = driverController.getDriveRotationAngle();
        if (driverController.snapToAmpAngle()) {
            return Optional.of(Rotation2d.fromDegrees(90.0));
        } else if (rightStickHeading.isPresent()) {
    ...
    private void configureBindings() {
        ...
        // .whileTrue(new TurnToHeadingCommand(sDrivetrainSubsystem,
