...
import frc.robot.commands.NavAmpCommand;
...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                driverController.povUp()
                                .whileTrue(new NavTrapCommand(sDrivetrainSubsystem, mArm, mShooter, mIntake, mTransfer,
                                                mTrapFan))
        ...
        public void pushChooser() {
                ...
                mChooser.addOption(
                                "center4",
                                new Home4AutoCommand(mIntake, mShooter, mArm, mTransfer, sDrivetrainSubsystem));
                mChooser.addOption(
                                "home2chase1",
                                new Home2ChaseMid1AutoCommand(mIntake, mShooter, mArm, mTransfer,
                                                sDrivetrainSubsystem));
                mChooser.addOption(
                                "home4",
                                new Home4AutoCommand(mIntake, mShooter, mArm, mTransfer, sDrivetrainSubsystem));
