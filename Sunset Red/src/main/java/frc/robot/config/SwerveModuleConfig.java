 ...
 * Custom Swerve Module Config for Team 6907, this current version is from the 
 * 2024 robot, "Krait".
 */
public class SwerveModuleConfig {
    /**
        ...
        /**
         * The (roughly estimated) module position when the lightgate detect carbon plate. 
         * We will use the section [centerDegree - 180.0 / RATIO, centerDegree + 180.0 / RATIO]
         * to calibrate module and add offset to azimuthEncoderOffsetRotation
        ...
        /**
         * Which corner the module is at.
         * Contains `ModuleCorner.modulePosision`, which is the position relative to the robot, from wheel center to robot center.
         */
        public ModuleCorner corner = null;

        public enum ModuleCorner {
            Front_Left("FL", new Translation2d(DriveConstants.kTrackWidth / 2, DriveConstants.kWheelBase / 2)),
            Front_Right("FR", new Translation2d(DriveConstants.kTrackWidth / 2, -DriveConstants.kWheelBase / 2)),
            Back_Left("BL", new Translation2d(-DriveConstants.kTrackWidth / 2, DriveConstants.kWheelBase / 2)),
            Back_Right("BR", new Translation2d(-DriveConstants.kTrackWidth / 2, -DriveConstants.kWheelBase / 2));
