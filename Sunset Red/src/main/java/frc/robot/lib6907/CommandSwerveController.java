...
public class CommandSwerveController extends CommandXboxController {
    ...
    private final SlewRateLimiter mRampX = new SlewRateLimiter(5); // (1 / seconds_from_neutral_to_full)
    private final SlewRateLimiter mRampY = new SlewRateLimiter(5); // (1 / seconds_from_neutral_to_full)
    private final SlewRateLimiter mRampTurn = new SlewRateLimiter(5); // (1 / seconds_from_neutral_to_full)
    ...
    public double getDriveTargetAngle() {
        Translation2d headingVector = new Translation2d(trans_dir * getRightY(), trans_dir * getRightX());
