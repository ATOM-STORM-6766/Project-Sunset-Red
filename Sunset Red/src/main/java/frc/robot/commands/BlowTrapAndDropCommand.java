...
public class BlowTrapAndDropCommand extends SequentialCommandGroup {
    ...
    public BlowTrapAndDropCommand(TrapFan trapFan, Shooter shooter, Arm arm, Transfer transfer, double fanSpeed) {
        ...
        Command shootTrapCommand = new SequentialCommandGroup(
            new InstantCommand(() -> System.out.println("Starting to shoot after 2 seconds of blowing")),
