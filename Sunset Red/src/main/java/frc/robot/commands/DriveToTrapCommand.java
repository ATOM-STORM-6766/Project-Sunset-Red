...
public class DriveToTrapCommand extends Command {
  ...
  private static final Transform2d kTagToTargetPose =
      new Transform2d(0.78, 0, Rotation2d.fromDegrees(0.0));
  ...
  public void initialize() {
    ...
    Optional<Pose2d> tagpose =
        findVisibleTrapTagPose(ApriltagCoprocessor.getInstance().getShooterSideLatestResult());
  ...
  public boolean isFinished() {
    return (mNoTag)
        || (xController.atGoal() && yController.atGoal() && rotationController.atGoal());
  }
