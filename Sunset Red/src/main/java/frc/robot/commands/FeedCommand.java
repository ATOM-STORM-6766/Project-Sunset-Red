...
public class FeedCommand extends Command {
  ...
  public FeedCommand(Transfer transfer, Shooter shooter) {
    ...
    addRequirements(shooter); // we add this because we don't want default command to slow down shooter while feeding
    // but this require further testing because sequential command will add all command requirements.
  }
