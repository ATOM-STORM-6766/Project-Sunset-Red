package frc.robot.commands;
 ...
 public class ChaseNoteCommand extends Command {
     ...
     private static final double INTAKE_STATE_TIMEOUT = 1.0; // INTAKE will be considered failed if it takes longer than
                                                             // this
     private static final double STATE_TIMEOUT = 3.0; // other states will be considered failed if they take longer than
                                                      // this
