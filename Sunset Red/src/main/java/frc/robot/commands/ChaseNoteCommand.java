...
public class ChaseNoteCommand extends ParallelRaceGroup {
    public ChaseNoteCommand(
        ...
        addCommands(
                ...
                new ChaseCommand(sDrivetrainSubsystem, sGamePieceProcessor)
    ...
    private class ChaseCommand extends Command {
        ...
        public ChaseCommand(DrivetrainSubsystem drivetrainSubsystem, GamePieceProcessor gamePieceProcessor) {
        ...
        @Override
        public void execute() {
            Optional<PhotonTrackedTarget> targetOptional = sGamePieceCoprocessor.getClosestGamePieceInfo();
