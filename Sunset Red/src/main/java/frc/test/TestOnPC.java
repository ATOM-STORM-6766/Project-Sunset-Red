...
public class TestOnPC {
  public static void main(String[] args) {
    ...
    System.out.println(
        "Arm Angle:" + VisionShootConstants.kSpeakerAngleMap.get(robotToGoal.getNorm()) + " deg");
    System.out.println(
        "Shooter Speed:" + VisionShootConstants.kSpeakerRPSMap.get(robotToGoal.getNorm()) + " rps");
  }
}
